...
export const FILE_SLICES = 'getFileSlices'
...
export const ACRONYMS = 'getAcronyms'

export const LOAD_FOLDERS = 'loadFolders'
export const LOAD_FOLDER = 'loadFolder'
export const PUT_FILE_FOLDER = 'putFileFolder'
